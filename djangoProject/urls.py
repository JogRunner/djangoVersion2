...
from student.views import dashboard, image_collocation, project,login,logout,register,image_manage,app_manage,app_create,create_project,deploy,app_detail,image_detail
...
urlpatterns = [
    ...
    url(r'^image_detail/$',image_detail,name='image_detail'),
